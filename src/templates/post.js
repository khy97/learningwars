...
export default function Template({data}) {
    ...
    return (
        <Layout>
            ...
            <div style={{background:`white`, padding:`30px 30px 10px`, borderRadius:2, boxShadow:`0 1px 3px rgba(0,0,0,0.12), 0 1px 2px rgba(0,0,0,0.24)`,  borderTop: `4px solid #ba3e32`}}>
