        ...
        <Layout>
          ...
          <div>
            {postList.edges.map(({node}, i) => (
              <div style={{borderRadius:2,boxShadow:`0 1px 3px rgba(0,0,0,0.12), 0 1px 2px rgba(0,0,0,0.24)`, border:`1px soild black`, background:`rgba(255,255,255,1)`, zIndex:5, marginBottom:20, padding:`20px 10px 20px 20px`, borderTop: `4px solid #ba3e32`}}>
                <Link to={node.frontmatter.path} style={{textDecoration:`none`, color:`black`,}}>
                  <div style={{display:`grid`, gridTemplateRows:`50px auto 50px`, fontFamily:`Raleway`}}>
                    ...
                    <div style={{gridRow:`3/4`, display:`flex`, flexDirection:`column`, fontSize:13, margin:`auto 0`, paddingTop:5, color:`#757575`,}}>
                      ...
                      <span>Written By: <Link to={`/author-blogs/${node.frontmatter.author.split(" ").join("_")}`} style={{color:`blue`, textDecoration:`none`}}>{node.frontmatter.author}</Link></span>
                    </div>
